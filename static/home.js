        ...
        .then(response => {
            response["data"].forEach(function (item) {
                ...
                document.getElementById('products').innerHTML += `
                    ...
                    <a href="./singlePage?pid=${item._id}" title="${item.title}">
                    <div class="zoomC" style="background: url('uploads/`+ item.art[0] + `');background-size: cover;oveflow : hidden;background-clip: padding-box;"></div>
                    ...
                    <div class="details">
                        ...
                        <button onclick="addToCart('${item._id}','${item.title}')">Add to Cart</button>
                    </div>
                </div>
                `;
            });
